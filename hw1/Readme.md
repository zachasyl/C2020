...
- Name(s):Zachary Sylvane
- How many hours did it take you to complete this Assignment?
  a lot mostly because i played around with vim/tmux a lot and ive never used
  the terminal or ssh before. the programming itself didnt take long

- Did you collaborate with any other students/TAs/Professors? piazza was sufficient
- Did you use any external resources? (Cite them below)
  - piazza
  - every resource recommended by the course website
  - https://www.programiz.com/c-programming/c-arrays-functions
  - above link helped when i was having issues passing array into function
